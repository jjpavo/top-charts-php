...
$(document).ready(function() {
  handleLabel = function(entry) {
    ...
    var label = document.getElementById(entry.id + "-label");
    label.style.display = "block";
    if(label.previousElementSibling.tagName === "SPAN") {
      label.previousElementSibling.style.display = "block";
    }
  }

  var inputRowWraps = document.getElementsByClassName('input-row-wrap');
  var labelIds;
  for(var inputRowWrap in inputRowWraps) {
    console.log(inputRowWrap)
    labelIds += inputRowWrap.querySelectorAll('input');
  }
   // labelIds = document.getElementsByClassName('input-row-wrap').querySelectorAll('input');
